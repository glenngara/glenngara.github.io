...
summary {background: -webkit-linear-gradient(top, #FAFAFA 50%, #E1E1E1 50%); border-radius: 5px; cursor: pointer; font-size: .7em; font-weight: bold; margin: -1%; padding: 8px 0; position: relative; width: 102%;}
...
details[open] summary:before {content: "-"; margin-top: -4px; font-size: .7em;}
p {font-size: .8em;}
</style>
