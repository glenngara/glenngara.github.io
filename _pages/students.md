...
summary {background: -webkit-linear-gradient(top, #FAFAFA 50%, #FAFAFA 50%); border-radius: 5px; cursor: pointer; font-size: .65em; font-weight: bold; margin: -1%; padding: 8px 0; position: relative; width: 102%;}
